        ...
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/[0.08] bg-white/[0.03] p-6 backdrop-blur-sm">
            ...
            <div className="mt-10">
              <a
                href="/contact"
                className="block w-full rounded-xl border border-white/15 bg-white/[0.04] px-5 py-3 text-center text-sm font-semibold text-white transition-all duration-200 ease-out hover:bg-white/[0.08] hover:border-white/30 hover:-translate-y-[1px]"
              >
                Contact
              </a>
            </div>
